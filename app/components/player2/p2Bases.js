      ...
      <View style={styles.container}>
        <View style={styles.bases}>
          <View style={styles.iconContainer}>
            <Svg
              width={82 * (Responsive.SVG_SCALE - 0.1)}
              height={82 * (Responsive.SVG_SCALE - 0.1)}
              viewBox="0 0 82 82"
            >
              <Path
                fill="#000"
                ...
                strokeWidth="2"
                d="M81 1v16.444C81 70.284 41 81 41 81S1 70.284 1 17.444c0-4.151.14-11.412.236-16.05C5.12 7.723 12.516 11.997 21 11.997c8.658 0 16.183-4.452 20-10.997 3.817 6.545 11.342 10.997 20 10.997S77.183 7.545 81 1z"
              />
            </Svg>
        ...
        <View style={styles.buttonContainer}>
          <TouchableHighlight
            ...
            onPress={() => this.props.minusDefenseP2()}
          >
          ...
          <TouchableHighlight
            ...
            underlayColor={'#9E9E9E'}
            onPress={() => this.props.addDefenseP2()}
          >
